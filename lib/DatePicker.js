import require$$4, { createElement, Component, useState, useRef } from 'react';
import PropTypes__default from 'prop-types';
import { a as createCommonjsModule, h as unwrapExports, j as require$$2$1, b as _interopRequireDefault, c as require$$0, d as require$$1, g as _ThemeProvider, m as commonjsGlobal, i as styleInject } from './chunk-b1961f5e.js';
import './chunk-2d4655dd.js';
import { findDOMNode } from 'react-dom';
import { e as Popper, f as Manager, g as Reference, b as require$$6$1, a as require$$7, c as _reactPopper, d as require$$4$1 } from './chunk-342f65bc.js';
import './chunk-3beaf8a1.js';
import { a as require$$8 } from './chunk-af425fee.js';
import './chunk-ffe689f1.js';
import { a as require$$6, b as require$$5, c as require$$10, d as require$$8$1 } from './chunk-f2cd297b.js';
import { a as require$$6$2 } from './chunk-3efc617d.js';
  ...
  function YearDropdownOptions(props) {
    ...
    _this.renderOptions = function () {
      ...
      var options = _this.state.yearsList.map(function (year) {
        return require$$4.createElement(
          "div",
          {
          ...
          selectedYear === year ? require$$4.createElement(
            "span",
      ...
      if (!maxYear || !_this.state.yearsList.find(function (year) {
        ...
        options.unshift(require$$4.createElement(
          "div",
          {
          ...
          require$$4.createElement("a", { className: "react-datepicker__navigation react-datepicker__navigation--years react-datepicker__navigation--years-upcoming" })
        ));
      }
      ...
      if (!minYear || !_this.state.yearsList.find(function (year) {
        ...
        options.push(require$$4.createElement(
          "div",
          {
            className: "react-datepicker__year-option",
            ref: "previous",
          ...
          require$$4.createElement("a", { className: "react-datepicker__navigation react-datepicker__navigation--years react-datepicker__navigation--years-previous" })
        ));
      }
  ...
  function YearDropdown() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      return require$$4.createElement(
        ...
        require$$4.createElement("span", { className: "react-datepicker__year-read-view--down-arrow" }),
        require$$4.createElement(
          "span",
      ...
      return require$$4.createElement(WrappedYearDropdownOptions, {
        key: "dropdown",
        ref: "options",
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.renderOptions = function () {
      return _this.props.monthNames.map(function (month, i) {
        return require$$4.createElement(
          ...
          _this.props.month === i ? require$$4.createElement(
            "span",
  ...
  function MonthDropdown() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      return require$$4.createElement(
        ...
        require$$4.createElement("span", { className: "react-datepicker__month-read-view--down-arrow" }),
        require$$4.createElement(
          "span",
      ...
      return require$$4.createElement(WrappedMonthDropdownOptions, {
        key: "dropdown",
        ref: "options",
    ...
    _this.renderOptions = function () {
      return _this.state.monthYearsList.map(function (monthYear) {
        ...
        return require$$4.createElement(
          ...
          isSameMonthYear ? require$$4.createElement(
            "span",
  ...
  function MonthYearDropdown() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      return require$$4.createElement(
        ...
        require$$4.createElement("span", { className: "react-datepicker__month-year-read-view--down-arrow" }),
        require$$4.createElement(
          "span",
      ...
      return require$$4.createElement(WrappedMonthYearDropdownOptions, {
        key: "dropdown",
        ref: "options",
...
var Day = function (_React$Component) {
  ...
  function Day() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (event) {
      ...
      return require$$2$1("react-datepicker__day", dayClassName, "react-datepicker__day--" + getDayOfWeekCode(_this.props.day), {
...
var WeekNumber = function (_React$Component) {
  ...
  WeekNumber.prototype.render = function render() {
    ...
    return require$$4.createElement(
      "div",
      {
        className: require$$2$1(weekNumberClasses),
  ...
  function Week() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleDayClick = function (day, event) {
      ...
      if (_this.props.showWeekNumber) {
        ...
        days.push(require$$4.createElement(WeekNumber, { key: "W", weekNumber: weekNumber, onClick: onClickAction }));
      }
      return days.concat([0, 1, 2, 3, 4, 5, 6].map(function (offset) {
        var day = addDays(startOfWeek$$1, offset);
        return require$$4.createElement(Day, {
          key: offset,
          day: day,
          month: _this.props.month,
...
var Month = function (_React$Component) {
  ...
  function Month() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleDayClick = function (day, event) {
      ...
      while (true) {
        weeks.push(require$$4.createElement(Week, {
          key: i,
      ...
      return require$$2$1("react-datepicker__month-text", "react-datepicker__month-" + m, {
      ...
      return require$$2$1("react-datepicker__month", {
...
function CalendarContainer(_ref) {
  ...
  return require$$4.createElement(
    "div",
    { className: className },
    require$$4.createElement("div", _extends({ className: "react-datepicker__triangle" }, arrowProps)),
    children
  );
}
...
var Calendar = function (_React$Component) {
  ...
  function Calendar(props) {
    ...
    _this.header = function () {
      ...
      if (_this.props.showWeekNumbers) {
        dayNames.push(require$$4.createElement(
          "div",
    ...
    _this.renderYearDropdown = function () {
      ...
      return require$$4.createElement(YearDropdown, {
    ...
    _this.renderMonthDropdown = function () {
      ...
      return require$$4.createElement(MonthDropdown, {
        dropdownMode: _this.props.dropdownMode,
        locale: _this.props.locale,
    ...
    _this.renderMonthYearDropdown = function () {
      ...
      return require$$4.createElement(MonthYearDropdown, {
        dropdownMode: _this.props.dropdownMode,
        locale: _this.props.locale,
        dateFormat: _this.props.dateFormat,
    ...
    _this.renderMonths = function () {
      ...
      for (var i = 0; i < _this.props.monthsShown; ++i) {
        ...
        monthList.push(require$$4.createElement(
          "div",
          {
            key: monthKey,
    ...
    _this.renderTimeSection = function () {
      if (_this.props.showTimeSelect && (_this.state.monthContainer || _this.props.showTimeSelectOnly)) {
        return require$$4.createElement(Time, {
          selected: _this.props.selected,
    ...
    _this.renderInputTimeSection = function () {
      ...
      if (_this.props.showTimeInput) {
        return require$$4.createElement(inputTime, {
  ...
  Calendar.prototype.render = function render() {
    ...
    return require$$4.createElement(
      Container,
      {
        className: require$$2$1("react-datepicker", this.props.className, {
...
var PopperComponent = function (_React$Component) {
  ...
  PopperComponent.prototype.render = function render() {
    ...
    if (!hidePopper) {
      var classes = require$$2$1("react-datepicker-popper", className);
      popper = require$$4.createElement(
        Popper,
        _extends({
        ...
        function (_ref) {
          ...
          return require$$4.createElement(
            ...
            require$$4.cloneElement(popperComponent, { arrowProps: arrowProps })
          );
        }
      );
    }
    ...
    if (this.props.popperContainer) {
      popper = require$$4.createElement(this.props.popperContainer, {}, popper);
    }
...
var DatePicker = function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    _this.renderDateInput = function () {
      ...
      var className = require$$2$1(_this.props.className, (_classnames = {}, _classnames[outsideClickIgnoreClass] = _this.state.open, _classnames));

      var customInput = _this.props.customInput || require$$4.createElement("input", { type: "text" });
      ...
      return require$$4.cloneElement(customInput, (_React$cloneElement = {}, _React$cloneElement[customInputRef] = function (input) {
        _this.input = input;
    ...
    _this.renderClearButton = function () {
      if (_this.props.isClearable && _this.props.selected != null) {
        return require$$4.createElement("button", {
          type: "button",
  ...
  DatePicker.prototype.render = function render() {
    ...
    if (this.props.withPortal) {
      return require$$4.createElement(
        "div",
        null,
        !this.props.inline ? require$$4.createElement(
          "div",
          { className: "react-datepicker__input-container" },
          this.renderDateInput(),
          this.renderClearButton()
        ) : null,
        this.state.open || this.props.inline ? require$$4.createElement(
          "div",
    ...
    return require$$4.createElement(PopperComponent, {
      className: this.props.popperClassName,
      hidePopper: !this.isCalendarOpen(),
      popperModifiers: this.props.popperModifiers,
      targetComponent: require$$4.createElement(
        "div",
        { className: "react-datepicker__input-container" },
        this.renderDateInput(),
        this.renderClearButton()
...
var _elementType = _interopRequireDefault(require$$6);

var _componentOrElement = _interopRequireDefault(require$$5);

var _react = _interopRequireDefault(require$$4);

var _reactDom = _interopRequireDefault(require$$8);

var _Portal = _interopRequireDefault(require$$10);

var _RootCloseWrapper = _interopRequireDefault(require$$6$1);



var _forwardRef = _interopRequireDefault(require$$7);

var _WaitForContainer = _interopRequireDefault(require$$8$1);
...
var _Overlay = _interopRequireDefault(Overlay_1);

var _Fade = _interopRequireDefault(require$$6$2);
...
function wrapRefs(props, arrowProps) {
  ...
  props.ref = ref.__wrapped || (ref.__wrapped = function (r) {
    return ref((0, require$$8.findDOMNode)(r));
  });

  arrowProps.ref = aRef.__wrapped || (aRef.__wrapped = function (r) {
    return aRef((0, require$$8.findDOMNode)(r));
  });
}
...
var _isRequiredForA11y = _interopRequireDefault(require$$4$1);
...
var CustomHeader = function CustomHeader(_ref) {
  var date = _ref.date,
      ...
      props = _objectWithoutProperties$1(_ref, ["date", "changeYear", "changeMonth", "decreaseMonth", "increaseMonth", "prevMonthButtonDisabled", "nextMonthButtonDisabled"]);

  var years = getYearsRange(props);
  return require$$4.createElement("div", {
    style: {
      margin: 20,
      display: "flex",
      justifyContent: "center"
    }
  }, require$$4.createElement("button", {
    className: "react-datepicker__navigation react-datepicker__navigation--previous",
    onClick: decreaseMonth,
    disabled: prevMonthButtonDisabled
  }), require$$4.createElement("select", {
    ...
    return require$$4.createElement("option", {
      key: option,
      value: option
    }, option);
  })), require$$4.createElement("select", {
...
var DatePicker$1 = function DatePicker$1(_ref) {
  var selected = _ref.selected,
      ...
      props = _objectWithoutProperties$2(_ref, ["selected", "appendToBody", "customInput"]);
  ...
  if (!customInput && !appendToBody) {
    return require$$4.createElement(DatePicker, _extends$1({
      selected: internalDate,
      customInput: require$$4.createElement(Form.Control, {
        placeholder: props.placeholderText
      }) // className={classes}
      ,
      renderCustomHeader: function renderCustomHeader(headerProps) {
        return require$$4.createElement(CustomHeader, _extends$1({}, headerProps, props));
      },
      locale: en
    }, props, {
  ...
  var InputComponent = require$$4.cloneElement(customInput, {
    onFocus: function onFocus() {
  ...
  return require$$4.createElement(require$$4.Fragment, null, InputComponent, require$$4.createElement(Overlay, {
    target: inputRef.current,
    show: showDatePicker,
    placement: "auto"
  }, require$$4.createElement(Popover, {
    className: "popover-datepicker"
  }, require$$4.createElement(DatePicker, _extends$1({
    selected: internalDate,
