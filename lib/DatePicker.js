...
require('./chunk-05702d30.js');
require('./chunk-d573f2e4.js');
require('./chunk-5317ecde.js');
require('./chunk-cce894b4.js');
require('./chunk-3a9a18f1.js');
var __chunk_15 = require('./chunk-0212d094.js');
...
function onClickOutsideHOC(WrappedComponent, config) {
  ...
  function (_Component) {
    ...
    _proto.componentDidMount = function componentDidMount() {
      ...
      this.componentNode = __chunk_5._reactDom.findDOMNode(this.getInstance()); // return early so we dont initiate onClickOutside
    ...
    _proto.componentDidUpdate = function componentDidUpdate() {
      this.componentNode = __chunk_5._reactDom.findDOMNode(this.getInstance());
    };
    /**
...
var classnames = _interopDefault(__chunk_1._classnames);
...
var PopperComponent = function (_React$Component) {
  ...
  PopperComponent.prototype.render = function render() {
    ...
    return React.createElement(
      __chunk_9.reactPopper.Manager,
      null,
      React.createElement(
        __chunk_9.reactPopper.Reference,
        null,
        function (_ref2) {
          var ref = _ref2.ref;
          return React.createElement(
...
var DatePicker = function DatePicker(_ref) {
  var selected = _ref.selected,
      ...
      placement = _ref.placement,
      props = _objectWithoutProperties$1(_ref, ["selected", "appendToBody", "customInput", "placement"]);
  ...
  return React__default.createElement(React__default.Fragment, null, InputComponent, React__default.createElement(__chunk_15.Overlay, {
    transition: false,
    target: inputRef.current,
    show: showDatePicker,
    placement: placement
  }, React__default.createElement(__chunk_15.Popover, {
...
DatePicker.propTypes = {
  ...
  timeIntervals: PropTypes$1.number,
  placement: PropTypes$1.oneOf(["auto", "right", "left", "top", "bottom"]) // appendToBody: PropTypes.bool
