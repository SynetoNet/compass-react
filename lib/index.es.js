...
var Badge = function Badge(_ref) {
  var strong = _ref.strong,
      light = _ref.light,
      size = _ref.size,
      props = _objectWithoutProperties(_ref, ["strong", "light", "size"]);

  return react.createElement(BootstrapBadge, _extends({
    className: "\n    ".concat(light ? "light-border" : "", "\n    ").concat(strong ? "strong" : "", "\n    ").concat(size ? "width-" + size : "", "\n    ")
  }, props, {
    pill: true
  }));
};
...
Badge.propTypes = {
  variant: PropTypes.oneOf(["primary", "secondary", "warning", "success", "danger"]),
