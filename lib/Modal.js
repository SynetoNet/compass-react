...
var __chunk_3 = require('./chunk-154fc642.js');
...
Modal.propTypes = {
  ...
  actions: PropTypes$1.shape({
    primary: PropTypes$1.shape(actionsShape),
    secondary: PropTypes$1.shape(actionsShape),
    tertiary: PropTypes$1.shape(actionsShape)
  }),
  ...
  backdrop: PropTypes$1.oneOf([false, true, "static"]),
