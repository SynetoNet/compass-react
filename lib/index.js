...
var __chunk_2 = require('./chunk-285b7b5c.js');
var __chunk_3 = require('./chunk-73de1493.js');
var __chunk_4 = require('./chunk-84b3e559.js');
require('react-dom');
var __chunk_5 = require('./chunk-77bf322c.js');
var __chunk_6 = require('./chunk-d3f24cc3.js');
require('./chunk-6dcacfb1.js');
var __chunk_8 = require('./chunk-c76d02b3.js');
var Form = require('./Form-98cca713.js');
...
var wrapRef = function wrapRef(props) {
  ...
  props.ref = ref.__wrapped || (ref.__wrapped = function (r) {
    return ref((0, __chunk_1.require$$8.findDOMNode)(r));
  });
...
function (_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    if (this.props[handler]) this.props[handler]((0, __chunk_1.require$$8.findDOMNode)(this));
  };
...
function getColumn(column) {
  ...
  var _headerStyle = _objectSpread({}, headerStyle);

  if (oneline) {
    Object.assign(_style, _objectSpread({}, _style, {
  ...
  return _objectSpread({
    ...
    style: _objectSpread({}, _style),
    headerStyle: _objectSpread({}, _headerStyle)
  }, otherProps);
}
...
function (_React$Component) {
  ...
  function Table() {
    ...
    _this = _possibleConstructorReturn$1(this, (_getPrototypeOf2 = _getPrototypeOf$1(Table)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty$3(_assertThisInitialized$1(_this), "state", {
      selected: _this.props.selected
    });

    _defineProperty$3(_assertThisInitialized$1(_this), "handleOnSelect", function (row, isSelect, rowIndex, e) {
    ...
    _defineProperty$3(_assertThisInitialized$1(_this), "getSelected", function () {
      try {
        var _this$props = _this.props,
            data = _this$props.data,
            keyField = _this$props.keyField;
        return _this.node.selectionContext.selected.map(function (key) {
    ...
    _defineProperty$3(_assertThisInitialized$1(_this), "clearSelection", function () {
      _this.setState({
        selected: []
      });
    });

    _defineProperty$3(_assertThisInitialized$1(_this), "getActions", function (actions) {
      if (!actions) {
        return null;
      }
  ...
  _createClass$1(Table, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          props = _objectWithoutProperties$3(_this$props2, ["data", "columns", "keyField", "selectable", "onSelect", "pagination", "children", "search", "actions", "extra", "scrollable", "className"]); // can be memoized


      var _columns = columns ? this.getColumnsProp(columns) : this.getColumnsFromChildren(children);

      var _selectable = getSelectableOptions(selectable, this.handleOnSelect, this.state.selected);

      var _pagination = getPaginationOptions(pagination);

      var _actions = this.getActions(actions);
    ...
    key: "getColumnsProp",
    value: function getColumnsProp(columns) {
    ...
    key: "getColumnsFromChildren",
    value: function getColumnsFromChildren(children) {
...
_defineProperty$3(Table, "Col", "tr");
