import require$$4 from 'react';
import PropTypes__default, { oneOfType, func, element, bool } from 'prop-types';
import { a as createCommonjsModule, h as unwrapExports, b as _interopRequireDefault, q as require$$0, c as require$$0$1, d as require$$1, l as require$$2, e as require$$2$1, k as _interopRequireWildcard } from './chunk-b1961f5e.js';
...
var TransitionGroupContext = require$$4.createContext(null);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (typeof children === 'function') {
      ...
      return require$$4.createElement(TransitionGroupContext.Provider, {
        value: null
      }, children(status, childProps));
    }

    var child = require$$4.Children.only(children);
    return (// allows for nested Transitions
      require$$4.createElement(TransitionGroupContext.Provider, {
        value: null
      }, require$$4.cloneElement(child, childProps))
    );
  };
...
var _camelize = _interopRequireDefault(require$$0);
...
var _hyphenate = _interopRequireDefault(hyphenate_1);
...
var _camelizeStyle = _interopRequireDefault(camelizeStyle);
...
var _hyphenateStyle = _interopRequireDefault(hyphenateStyle);

var _getComputedStyle2 = _interopRequireDefault(getComputedStyle);

var _removeStyle = _interopRequireDefault(removeStyle_1);



var _isTransform = _interopRequireDefault(isTransform_1);
...
var _extends2 = _interopRequireDefault(require$$0$1);
...
var _Transition = _interopRequireWildcard(Transition);

var _end = _interopRequireDefault(end);

var _triggerBrowserReflow = _interopRequireDefault(triggerBrowserReflow_1);
...
export { Fade_1 as a, createChainableTypeChecker_1 as b, style_1 as c };
//# sourceMappingURL=chunk-3efc617d.js.map
